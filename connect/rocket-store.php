...
/*============================================================================*\
  ...
  A simple and yes powerfull flat file storage.
  ...
  News:
  2018-05-22
  data_storage_area path ending without a separator is taken as the final directory to store data files, where as a path ending sith a separator, will have a direcory added to it.
